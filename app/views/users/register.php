    ...
    <div class="col-md-6 mx-auto">
        <div class="card card-body bg-light mt-5">
            ...
            <form action="<?php echo URLROOT; ?>/users/register" method="POST">
                ...
                <div class="form-group">
                    <label for="confirm_password">Confirm Pssword: <sup>*</sup></label>
                ...
                <div class="row">
                    ...
                    <div class="col">
                        <a href="<?php echo URLROOT; ?>/users/login" class="btn btn-lgiht btn-block">Have an account ? Login</a>
                    </div>
                </div>
            </form>
        </div>
